...
export const Description = () => {
  ...
  const cv_pt =
    "https://drive.google.com/file/d/1pmOJkmnGt2n05tlWuYo5sOvnbOIVot2I/view?usp=drive_link";
  const cv_en =
    "https://drive.google.com/file/d/1_4Z5YZDKVJhlUOSoG04QEfFH-LIZbcu6/view?usp=drive_link";
